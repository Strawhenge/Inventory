...
namespace Strawhenge.Inventory.Tests.InventoryApparelPieceTests
{
    public class InventoryApparelPieceTests
    {
        ...
        public InventoryApparelPieceTests(ITestOutputHelper testOutputHelper)
        {
