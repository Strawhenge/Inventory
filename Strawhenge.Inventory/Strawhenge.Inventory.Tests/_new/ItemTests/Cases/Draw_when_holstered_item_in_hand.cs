...
{
    public class Draw_when_holstered_item_in_hand : BaseItemTest
    {
        readonly Item _hammer;
        readonly Item _spear;

        public Draw_when_holstered_item_in_hand(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
