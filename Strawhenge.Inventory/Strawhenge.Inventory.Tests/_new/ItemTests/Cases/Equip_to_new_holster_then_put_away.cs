...
{
    public class Equip_to_new_holster_then_put_away : BaseItemTest
    {
        readonly Item _hammer;

        public Equip_to_new_holster_then_put_away(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
