...
{
    public class CreateConsumeItemAnimationWizard : ScriptableWizard
    {
        const string Name = "Consume Item Animation...";

        [MenuItem("Assets/Create/Strawhenge/Inventory/Consume Item Animation...")]
        public static void ShowEditorWindow()
        {
            DisplayWizard<CreateConsumeItemAnimationWizard>(Name, "Create");
        }
        ...
        void OnWizardCreate()
        {
            CreateConsumeItemAnimation.Create(new CreateConsumeItemAnimationArgs(
                _animatorController,
        ...
        static string[] GetLayers(AnimatorController animatorController)
        {
            return animatorController != null
                ? animatorController
                    .GetLayersContaining<ConsumeItemStateMachine>()
                    .Select(x => x.name)
                    .ToArray()
                : Array.Empty<string>();
        }
